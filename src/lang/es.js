...
module.exports = {
  ...
  target: 'Target',
  targetContent: 'Empresas, instituciones y personas de alto perfil transaccional (Multinacionales, empresas de alto volumen de facturación, individuos de alto patrimonio, etc).',
  ...
  DigitalTitle: 'Consultoría en FOREX',
  ...
  PublicityTitle: 'Levantamiento de<br />deuda corporativa',
