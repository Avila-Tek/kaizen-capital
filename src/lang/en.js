...
module.exports = {
  ...
  links: [
    { name: 'home', href: '/en/#' },
    { name: 'about us', href: `/en/#${AboutUsId}` },
  ...
  AboutFirstColTitle: 'Continuous growth of financial services towards our allies',
  ...
  ExpertsTitle: 'Return on capital<br />(Financial loans)',
  ...
  PublicityTitle: 'Corporate<br />debt rises',
